    ...
    <div className={styles.container}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.important}>
          <strong>중요:</strong> ㈜헤비몰은 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고자 다음과 같은 처리방침을 두고 있습니다.
        </div>

        <div className={styles.article}>
          <div className={styles.articleNumber}>제1조 (개인정보의 처리목적)</div>
          <div className={styles.content}>
            ㈜헤비몰은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
          </div>
        ...
        <div className={styles.article}>
          ...
          <div className={styles.content}>
            ① ㈜헤비몰은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
            <br /><br />
