...
async function seedSimpleReviews() {
  try {
    console.log('단순화된 리뷰 구조로 데이터 시딩 시작...');
    console.log('구조: reviews/{reviewId} (productId는 필드로 저장)');
    ...
    console.log(`\n🎉 단순화된 리뷰 시딩 완료! 총 ${totalReviews}개 리뷰 생성됨`);
    console.log('이제 URL은 /reviews/{reviewId} 형태가 됩니다.');
    process.exit(0);
...
module.exports = { seedSimpleReviews };
